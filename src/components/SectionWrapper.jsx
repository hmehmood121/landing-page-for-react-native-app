...
const SectionWrapper = ({ title, description,showBtn, mockupImg, banner, reverse }) => {
  return (
    <div className={`min-h-screen ${styles.section} ${reverse?styles.bgWhite:styles.bgPrimary} ${banner}`}>
      ...
      <div className={`${styles.descDiv} fadeLeftMini ${reverse?" fadeRightMini": " fadeLeftMini"} ${reverse?styles.textRight:styles.textLeft}`}>
    ...
    {showBtn && (
      ...
      link = "https://expo.dev/@hmehmood121/nft-marketplace?serviceType=classic&distribution=expo-go"
      />
    )}
      </div>
